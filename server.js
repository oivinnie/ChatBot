...
app.post('/api/config', async (req, res) => {
    ...
    try {
        ...
        const configData = {
            ...
            cadastro_interessados_link: cadastro_interessados_link ? cadastro_interessados_link.trim() : '',
            validador_certificado_link: validador_certificado_link ? validador_certificado_link.trim() : '',
            theme: theme || 'indigo',
            emoji: emoji || '🤖',
